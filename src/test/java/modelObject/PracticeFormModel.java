...
// Câmpurile + getter/setter-urile tale rămân la fel

    public PracticeFormModel(String relativeJsonPath) {
        ...
        try {
            ...
            e.printStackTrace();
            throw new RuntimeException("Eroare la citirea fișierului JSON: " + relativeJsonPath);
        }
    }
