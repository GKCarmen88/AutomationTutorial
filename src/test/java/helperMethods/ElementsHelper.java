...
public class ElementsHelper {
    ...
    public void validateSizeList(By locator, int expectedSize){
        ...
        int initialTabelSize = initialList.size(); //extragem dimensiunea listei
        Assert.assertEquals(initialTabelSize,expectedSize,"dimensiunea initiala a tabelului nu este " + expectedSize );
